        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { title: "Advanced Security", description: "SOC 2 compliance, SSO, and advanced access controls" },
              { title: "API Access", description: "Full API access for custom integrations and workflows" },
              { title: "Dedicated Support", description: "24/7 support with dedicated account manager" },
              { title: "Custom Setup", description: "Tailored implementation and training for your team" }
            ].map((feature, index) => (
              <div 
                key={index}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 animate-fade-in-delay">
              Everything you need to know about One Vans pricing
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="backdrop-blur-md bg-black/5 border border-black/10 rounded-2xl p-12 transform transition-all duration-500 hover:scale-105">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Try One Vans risk-free for 30 days. If you're not completely satisfied, we'll refund your money, no questions asked.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-12 transform transition-all duration-500 hover:scale-105">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of construction professionals who have streamlined their workflows with One Vans.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
